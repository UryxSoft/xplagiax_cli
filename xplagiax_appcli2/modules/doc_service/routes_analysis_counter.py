...
from app import db
import requests
from modules.models.model import Users, AnalysisLimit, UserAnalysisUsage, StoragePlan
...
def validate_and_analyze():
    ...
    try:
        ...
        response = requests.post(
            'http://127.0.0.1:5000/x_aitestpro/api/analyze-batch', #'http://127.0.0.1:5000/x_aitestpro/api/analyze-batch',
            json=data,
