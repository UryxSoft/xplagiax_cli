...
class UploadToast {
    ...
    createDOM() {
        ...
        this.container.innerHTML = `
            <div class="upload-toast-header">
                ...
                <div class="upload-toast-actions">
                    <button class="upload-toast-btn toggle-size" title="Minimize">
                        <i class="bi bi-dash"></i>
                    </button>
                    <button class="upload-toast-btn close" title="Close" style="display: none;">
                        <i class="bi bi-x"></i>
                    </button>
                </div>
            </div>
        ...
        this.elements = {
            ...
            toggleSizeBtn: this.container.querySelector('.upload-toast-btn.toggle-size'),
    ...
    bindEvents() {
        ...
        // Toggle button - toggle minimize/restore
        if (this.elements.toggleSizeBtn) {
            this.elements.toggleSizeBtn.addEventListener('click', (e) => {
    ...
    expand() {
        ...
        if (this.elements.toggleSizeBtn) {
            this.elements.toggleSizeBtn.title = 'Minimize';
            this.elements.toggleSizeBtn.innerHTML = '<i class="bi bi-dash"></i>';
        }
    }
    ...
    collapse() {
        ...
        if (this.elements.toggleSizeBtn) {
            this.elements.toggleSizeBtn.title = 'Maximize';
            this.elements.toggleSizeBtn.innerHTML = '<i class="bi bi-arrows-angle-expand"></i>';
        }
    }
    ...
    updateProviderIcon() {
        ...
        if (provider && this.PROVIDER_CONFIG[provider]) {
            ...
            // Hide close button for cloud providers
            if (this.elements.closeBtn) {
            ...
            // Show close button for native uploads
            if (this.elements.closeBtn) {
